                        ...
                        <div class="row">
                            <div class="col-12 col-md-3">
                                <div class="programing__card">
                                    <div class="programing__image">
                                        <img src="https://cdn.mensagenscomamor.com/content/images/m000579550.jpg?v=2" class="rounded-circle img-fluid border--right">
                                    </div>
                                    <div class="programing__info">
                                        <h3 class="programing__title">Nome do Programa</h3>
                                        <p class="programing__announcer">Nome do Locutor</p>
                                        <span class="programing__hour">A partir das 08 horas</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                                <div class="programing__card">
                                    <div class="programing__image">
                                        <img src="https://cdn.mensagenscomamor.com/content/images/m000579550.jpg?v=2" class="rounded-circle img-fluid border--top">
                                    </div>
                                    <div class="programing__info">
                                        <h3 class="programing__title">Nome do Programa</h3>
                                        <p class="programing__announcer">Nome do Locutor</p>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="programing__card">
                                    <div class="programing__image">
                                        <img src="https://cdn.mensagenscomamor.com/content/images/m000579550.jpg?v=2" class="rounded-circle img-fluid border--left">
                                    </div>
                                    <div class="programing__info">
                                        <h3 class="programing__title">Nome do Programa</h3>
                                        <p class="programing__announcer">Nome do Locutor</p>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="programing__card">
                                    <div class="programing__image">
                                        <img src="https://cdn.mensagenscomamor.com/content/images/m000579550.jpg?v=2" class="rounded-circle img-fluid border--bottom">
                                    </div>
                                    <div class="programing__info">
                                        <h3 class="programing__title">Nome do Programa</h3>
                                        <p class="programing__announcer">Nome do Locutor</p>
