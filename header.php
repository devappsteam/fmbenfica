                    ...
                    <div class="col-12 col-md-8">
                        <div class="header__phones">
                            <div class="header__phone">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 172 172" style=">
                            ...
                            <div class="header__phone">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 172 172">
                                    <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                                        <path d="M0,172v-172h172v172z" fill="none"></path>
                                        <g fill="#ffffff">
                                            <path d="M0,20.64v3.44v120.4h172v-123.84zM6.88,27.52h158.24v8.80156c-1.51873,1.32065 -62.54893,54.38869 -67.61078,58.77562c-4.44303,3.85063 -9.17766,4.66281 -11.50922,4.66281c-2.33156,0 -7.06619,-0.81219 -11.50922,-4.66281c-1.27764,-1.10729 -10.43622,-9.07239 -17.06563,-14.835l-0.04703,-0.06047l-0.01344,0.00672c-19.64841,-17.07952 -49.48551,-43.01817 -50.48469,-43.88687zM6.88,45.4389c5.3307,4.63347 26.96866,23.43969 44.99547,39.10985l-44.99547,35.55562zM165.12,45.4389v74.99469l-45.09625,-35.79078c18.01634,-15.66102 39.75464,-34.55986 45.09625,-39.20391zM57.16313,89.14437c4.25253,3.696 11.85269,10.30951 12.82609,11.15313c5.87697,5.09337 12.15034,6.3425 16.01078,6.3425c3.86044,0 10.13381,-1.24913 16.01078,-6.3425c0.96606,-0.83725 8.53023,-7.41389 12.73203,-11.06578l50.37719,39.98328v8.385h-158.24v-8.72094z"></path>
                                        </g>
                                    </g>
                                </svg>
                                ...
                                <a href="">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35" viewBox="0 0 172 172">
                                        <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                                            <path d="M0,172v-172h172v172z" fill="none"></path>
                                            <g fill="#ffffff">
                                                <path d="M129,18.8125h-86c-11.87337,0 -21.5,9.62663 -21.5,21.5v86c0,11.87338 9.62663,21.5 21.5,21.5h45.6875v-45.6875h-16.125v-18.8125h16.125v-13.4375c0,-18.8125 10.75,-29.5625 26.875,-29.5625c8.41994,0 13.4375,2.6875 13.4375,2.6875v16.125h-10.75c-7.68625,0 -10.75,5.62494 -10.75,10.75v13.4375h18.8125l-2.6875,18.8125h-16.125v45.6875h21.5c11.87338,0 21.5,-9.62662 21.5,-21.5v-86c0,-11.87337 -9.62662,-21.5 -21.5,-21.5z"></path>
                                            </g>
                                        </g>
                                    </svg>
                                </a>
            ...
            <div id="main_slider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://wallpapercave.com/wp/wp4018814.jpg" class="d-block w-100" alt="...">
                    ...
                    <div class="carousel-item">
                        <img src="https://wallpapercave.com/dwp1x/wp4018815.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                        <img src="https://wallpapercave.com/dwp1x/wp4018816.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="col-12 p-0">
                        <div class="row">
                            <div class="col-12 col-md-3">
                                <div class="programing_card">
                                    <div class="programing_image">
                                        <img src="https://cdn.mensagenscomamor.com/content/images/m000579550.jpg?v=2" class="rounded-circle img-fluid">
                                    </div>
                                    <div class="programing_info">
                                        <div class="programing_title">
                                            <h3>Nome do Programa</h3>
                                        </div>
                                        <div class="programing_description">
                                            <p class="programing_announcer">Nome do Locutor</p>
                                            <span class="programing_hour">A partir das 08 horas</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="noticies" id="noticies">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 noticies__slider" id="noticies_slider">
                        <div class="noticies__slide" style="background-image: url('https://p4.wallpaperbetter.com/wallpaper/449/542/349/hd-nature-mountain-1920x1080-wallpaper-preview.jpg');">
                            <div class="noticies__slide-header">
                                <span class="noticies_date">23 de Janeiro de 2022</span>
                            </div>
                            <div class="noticies__description">
                                <h3>
